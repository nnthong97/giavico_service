...
public class DocumentApprovalEntity {
    ...
    DocumentApprovalEntity(RndDocumentEntity document, String action, String actor, String comment) {
        this.document = document; this.action = action; this.actor = actor.trim(); this.comment = comment == null ? "" : comment.trim(); this.createdAt = Instant.now();
    }
